# Desafio: Sistema de Adoção para Pets (CLI)
...
Leia **TODO** o desafio com **ATENÇÃO** antes de começar a fazê-lo e respeite as regras, evite o uso do GPT ao máximo e use-o com sabedoria quando necessário!
...
> **Regra:** Não é permitido usar o "print" nas perguntas no código, você deverá **LER** o arquivo!
...
Agora, ao salvar o PET em um objeto, você deverá salvar as respostas em um arquivo `.txt` com o nome formatado da seguinte maneira: `20231101T1234-FLORZINHADASILVA.TXT`.
...
1 - Florzinha da Silva 2 - Gato 3 - Femea 4 - Rua 2, 456, Seilandia 5 - 6 anos 6 - 5kg 7 - Siames
...
* O formato de resposta, deverá exibir **SEMPRE** uma lista de possíveis resultados, por exemplo:

Rex - Cachorro - Macho - Rua 1, 123 - Cidade 1 - 2 anos - 5kg - Vira-lata

Florzinha da Silva - Gato - Femea - Rua 2, 456 - Seilandia - 6 anos - 5kg - Siames
...
* Toda busca deverá ser **case-sensitive**, ou seja, ignorar maiúscula e minúscula (tratando como iguais) e acentos.
...
Ao selecionar a opção 5 (ou 0, dependendo da sua implementação no Passo 2), o programa deverá ser encerrado.
...
#### Regras Opção 1 ⚠️ (Criar nova pergunta)
...
#### Regras Opção 2 ⚠️ (Alterar pergunta existente)
...
#### Regras Opção 3 ⚠️ (Excluir pergunta existente)
...
* Caso existam 9 perguntas (2 adicionadas), e o usuário **DELETE A PERGUNTA 8**, a pergunta 9 deverá tomar o lugar da 8 (renumerar).
...
1 - Florzinha da Silva 2 - Gato 3 - Femea 4 - Rua 2, 456, Seilandia 5 - 6 anos 6 - 5kg 7 - Siames 8 - [EXTRA - PERGUNTA NOVA ADICIONADA] - RESPOSTA DO USUÁRIO 9 - [EXTRA - PERGUNTA NOVA ADICIONADA] - RESPOSTA DO USUÁRIO

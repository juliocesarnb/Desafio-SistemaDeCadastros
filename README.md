Claro! Segue a descrição do desafio formatada em Markdown, mantendo a estrutura original:
...
Sair (ou 0, como é comum em menus CLI)
...
Iniciar o sistema para cadastro de PETS

Iniciar o sistema para alterar formulário
